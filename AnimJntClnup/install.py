...
DIRECTORY = os.path.join(USERAPPDIR, 'scripts', 'AnimJntClnup')

script_folder = DIRECTORY
script_name = 'clearUnwantedAnimKeys.py'
...
def create_shelf_button(script_folder, script_name):
    ...
    icon_path = os.path.join(script_folder, 'DeteteWeaponAnimKeys.png')

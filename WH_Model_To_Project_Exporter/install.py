...
DIRECTORY = os.path.join(USERAPPDIR, 'scripts', 'WH_Model_To_Project_Exporter')

script_folder = DIRECTORY
script_name = 'ModelExporterRun.py'
...
def create_shelf_button(script_folder, script_name):
    ...
    icon_path = os.path.join(script_folder, 'WH_Model_To_Project_Exporter_Icon.png')

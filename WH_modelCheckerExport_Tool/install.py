...
DIRECTORY = os.path.join(USERAPPDIR, 'scripts', 'WH_modelCheckerExport_Tool')

script_folder = DIRECTORY
script_name = 'modelCheckerRun.py'
...
def create_shelf_button(script_folder, script_name):
    ...
    icon_path = os.path.join(script_folder, 'WH_Model_Export.png')
